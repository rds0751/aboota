...
class AbstractBasket(models.Model):
    ...
    def total_cashback(self):
        return self._get_total('line_discount')

    @property
    def total_jr_credit(self):
        return None
    ...
    def total_cashback(self):
        ...
        Return total price inclusive of tax but exclusive discounts
        """
        return self._get_total('line_cashback_incl_tax')
    ...
    def total_jr_credit(self):
        ...
        Return total price inclusive of tax but exclusive discounts
        """
        return self._get_total('line_jr_credit_incl_tax')
...
class AbstractLine(models.Model):
    ...
    @property
    def unit_cashback_incl_tax(self):
        return self.purchase_info.price.cashback

    @property
    def unit_jr_credit_incl_tax(self):
        return self.purchase_info.price.jr_credit
    ...
    @property
    def line_cashback_incl_tax(self):
        if self.unit_cashback_incl_tax is not None:
            return self.quantity * self.unit_cashback_incl_tax

    @property
    def line_jr_credit_incl_tax(self):
        if self.unit_jr_credit_incl_tax is not None:
            return self.quantity * self.unit_jr_credit_incl_tax

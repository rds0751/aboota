...
class AbstractOrder(models.Model):
    ...
    guest_email = models.EmailField(_("Guest email address"), blank=True, null=True)
    ...
    @property
    def lname(self):
        return self.shipping_address.last_name
    ...
    @property
    def addline1(self):
        return self.shipping_address.line1

    @property
    def addline2(self):
        return self.shipping_address.line2
    ...
    @property
    def city(self):
        return self.shipping_address.line4

    @property
    def pincode(self):
        return self.shipping_address.postcode
